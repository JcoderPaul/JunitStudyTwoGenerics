...
public class MyOwnLinkedList<T> implements MyOwnList<T> {
    /*
    ...
    */
    ...
    public boolean add(T elementOfList) {
        ...
        if (size == 0) {
            ...
            first = new Node(null, elementOfList, null);
            /*
            ...
            */
            last = new Node(prevLast, elementOfList, null);
            /*
    ...
    public boolean add(T elementOfList, int index) {
        ...
        */
        ...
        Node newNode = new Node(nodePrevious, elementOfList, nodeNext);
    ...
    public boolean remove(T elementOfList) {
        ...
        */
        ...
        for (int i = 0; i < size; i++) {
            if (node.value.equals(elementOfList)) {
                /*
    ...
    */
    ...
    public boolean contains(T elementOfList) {
        return findElement(elementOfList) != -1;
    }

    private int findElement(T elementOfList) {
        Node node = first;
        for (int i = 0; i < size; i++) {
            if (node.value.equals(elementOfList)) {
                return i;
    ...
    public Iterator<T> iterator() {
        ...
        return new Iterator<T>() {
            ...
            */
            @Override
            public void remove() {
                MyOwnLinkedList.this.removeAt(--index);
            }
        };
    }
